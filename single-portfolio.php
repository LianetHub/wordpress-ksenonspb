	...
	<article class="case-page">
		...
		<?php if (ksenon_get_post_field('case_description', $post_id)) : ?>
			<section class="case-description">
				<div class="case-description__container container typography-block">
					<?php the_content(); ?>
		...
		?>
			<section class="case-done">
				<div class="case-done__container container">
		...
		?>
			<section class="case-process">
				<div class="case-process__container container">
		...
		?>
			<section class="case-components">
				<div class="case-components__container container">
		...
		?>
			<section class="case-related">
				<div class="case-related__container container">
